                    ...
                    svg: {
                        ...
                        onPress: () => {
                            if (index === 0) {
                                ...
                                Alert.alert('Total Entertainment = $' + (Number(this.props.entertainment)).toFixed(2))
                            }
                        },
                    },
                    key: `pie-${index}`
        ...
        return (
            <View style={styles.container}>
                <View style={styles[this.props.theme]}>
                    <Text
                        style={styles.balanceText}>{'$' + (Number(this.props.bills) + Number(this.props.food) + Number(this.props.entertainment)).toFixed(2)}</Text>
                    <View style={styles.pieChart}>
                        {pieData.length === 0
                            ? (
                                <Fragment>
                                    <Text style={styles.paragraph}>{'You have no receipts.'}</Text>
                                    <View
                                        style={[
